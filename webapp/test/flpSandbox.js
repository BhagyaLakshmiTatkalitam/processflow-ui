		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comcyprocessflowui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcyprocessflowui-display": {
								"semanticObject": "comcyprocessflowui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cy.processflowui",
									"url": sap.ui.require.toUrl("com/cy/processflowui")
								}
							}
						}
					}
